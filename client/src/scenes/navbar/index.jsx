...
const NavBar = () => {
  ...
  return (
    <FlexBetween padding="1rem 6%" backgroundColor={alt}>
      ...
      {/*Mobile Nav*/}
      {!isNonMobileSreens && isMobileMenuToggled && (
        <Box
          position={"fixed"}
          right="0"
          bottom="0"
          ...
          <Box display="flex" justifyContent="flex-end" p="1rem">
            <IconButton onClick={() => setIsMobileMenuToggled(!isMobileMenuToggled)}>x</IconButton>
          </Box>
          {/*Menu Items*/}
          <FlexBetween
            display="flex"
            ...
            alignItems="center"
            gap="3rem">
            <IconButton sx={{ fontSize: "25px" }} onClick={() => dispath(setMode())}>
              {theme.palette.mode === "dark" ? (
                <DarkMode sx={{ fontSize: "25px" }} />
              ) : (
                <LightMode sx={{ color: dark, fontSize: "25px" }} />
